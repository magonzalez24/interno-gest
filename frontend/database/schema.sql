...
-- Los campos office_id y department_id se utilizan para filtrar empleados por sede y departamento
-- en el modal de añadir miembros al equipo del proyecto.
...
-- Esta tabla permite relacionar empleados con sus tecnologías/habilidades.
-- Se utiliza para filtrar empleados por tecnologías en el modal de añadir miembros al equipo.
